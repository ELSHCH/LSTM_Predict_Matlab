function [t_f,Y_f_mean,Y_f_std]=LSTM_PATTERN_train(time_begin,sampleS,bs,time_end,nVar,t_tr,X_tr,t_down,X_down,numHiddenUnits,number_Epochs,ind_predictors,ind_responses,net)
